...
$(document).ready(function () {
    ...
    hf.applyPageTemplate(agency + " Penalty Calculator", agency).done(function () {
        hf.setLastDataUpdateDate("CALCULATOR");
            ...
            $("#execProjection").on("click", function (e) {
                ...
                vmCalc.getEgregiousPrediction(agency, factors).done(function (projection) {
                    ...
                    Promise.all(prmMitigation).then((projections) => {
                        ...
                        penaltyHigh = Math.max(0, calculatedPenaltyVSDYes - (calculatedPenaltyVSDYes * ((projections[0].mitigationVSDYes - 25) / 100)));
                        penaltyLow = Math.max(0, calculatedPenaltyVSDYes - (calculatedPenaltyVSDYes * ((projections[0].mitigationVSDYes + 25) / 100)));
                        $("#penaltyVSDYes").text(kendo.toString(penaltyLow, "C0") + " to " + kendo.toString(penaltyHigh, "C0"));
                        penaltyHigh = Math.max(0, calculatedPenaltyVSDNo - (calculatedPenaltyVSDNo * ((projections[1].mitigationVSDYes - 25) / 100)));
                        penaltyLow = Math.max(0, calculatedPenaltyVSDNo - (calculatedPenaltyVSDNo * ((projections[1].mitigationVSDYes + 25) / 100)));
