...
class GuidanceResults {
    ...
    getByECCN(cclCategory, productGroup, eccn) {
        ...
        var sender = this;
        vmGuidance.getGuidanceDocumentsByECCN(cclCategory, productGroup, eccn, this.agency).then(function (searchResults) {
        ...
        if (guidance.length == 0) {
            ...
            $.each(guidance, function () {
                try {
                    ...
                    var link;
                    if (this.LocalSource == null || this.LocalSource == "") {
                        link = this.Source;
                    } else {
                        link = "documents" + this.LocalSource;
                    }
                    ...
                    kendo.alert("An error occurred while binding the Guidance Document results");
                }
